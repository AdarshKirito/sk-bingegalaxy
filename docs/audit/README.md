...
> **Historical/detail set with current supplements.** The canonical current 2026-07-16 set is [`../00-AUDIT-INDEX.md`](../00-AUDIT-INDEX.md) through [`../28-PRODUCTION-READINESS-CHECKLIST.md`](../28-PRODUCTION-READINESS-CHECKLIST.md). Counts/headline findings below describe the original July 11–12 audit unless a section is explicitly dated later. For current status use [`../23-ISSUE-REGISTER.md`](../23-ISSUE-REGISTER.md) or the current-state section at the top of `17-ISSUE-REGISTER.md`.
