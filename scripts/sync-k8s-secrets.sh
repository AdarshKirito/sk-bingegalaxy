...
kubectl -n "$NAMESPACE" create secret generic app-secrets \
  ...
  --from-literal=WEBPUSH_PUBLIC_KEY="$WEBPUSH_PUBLIC_KEY" \
  --from-literal=WEBPUSH_PRIVATE_KEY="$WEBPUSH_PRIVATE_KEY" \
