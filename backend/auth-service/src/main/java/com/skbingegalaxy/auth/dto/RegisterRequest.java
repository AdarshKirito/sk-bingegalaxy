...
public class RegisterRequest {
    ...
    /**
     * National (subscriber) portion of the phone number, digits only. The
     * E.164 country-code prefix is sent separately in {@link #phoneCountryCode}.
     */
    @NotBlank(message = "Phone number is required")
    @Pattern(regexp = "^\\d{4,15}$", message = "Phone must be 4-15 digits without spaces or symbols")
    private String phone;

    /** E.164 dial prefix including the leading '+', e.g. "+91". */
    ...
    // ── Optional postal address (production-grade structured fields) ──
