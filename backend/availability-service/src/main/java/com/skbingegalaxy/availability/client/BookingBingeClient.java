 ...
 * admin availability endpoints return 403, and it hides non-approved venues
 * that admins still manage.
 */
...
public interface BookingBingeClient {
     ...
     *               this service enforce BLOCKED_DATES in the same round trip
     *               as the ownership check. Pass null for anonymous reads
     *               (operating-hours cache warms).
     */
