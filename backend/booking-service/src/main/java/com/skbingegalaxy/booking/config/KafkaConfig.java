...
public class KafkaConfig {
    ...
    // Right-to-erasure fan-out (DATA-004): a poison user.anonymized record must
    // park, not vanish — a dropped one means residual PII downstream.
    @Bean
    public NewTopic userAnonymizedDltTopic() {
        return deadLetterTopic(KafkaTopics.USER_ANONYMIZED);
    }
