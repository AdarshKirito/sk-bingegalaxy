...
- Name: admin-dashboard.spec.js >> Admin without binge selected >> admin dashboard redirects to platform without binge
- Location: e2e\admin-dashboard.spec.js:92:3
